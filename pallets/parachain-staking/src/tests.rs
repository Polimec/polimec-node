	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			let roll_through_steady_state_round = |round: BlockNumber| -> BlockNumber {
				...
				assert_events_eq!(
					Event::CollatorChosen { round: round, collator_account: 1, total_exposed_amount: 400 },
					Event::CollatorChosen { round: round, collator_account: 2, total_exposed_amount: 400 },
					Event::CollatorChosen { round: round, collator_account: 3, total_exposed_amount: 400 },
					Event::CollatorChosen { round: round, collator_account: 4, total_exposed_amount: 400 },
					Event::NewRound {
...
fn test_on_initialize_weights() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(Weight::from_parts(304110000, 1832), weight);
			...
			let expected_on_init = 2053713382;
			assert_eq!(Weight::from_parts(expected_on_init, 42845), weight);
			...
			assert_eq!(Weight::from_parts(expected_weight, 42845), weight);
