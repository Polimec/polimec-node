...
use polimec_instantiator::jwt_utils::{generate_did_from_account, get_mock_jwt, get_mock_jwt_with_cid};
...
// pub type MockInstantiator = polimec_instantiator::Instantiator<
// 	TestRuntime,
// 	<TestRuntime as crate::Config>::AllPalletsWithoutSystem,
// 	RuntimeEvent,
// >;
