...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(23_609_400, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 671
			.saturating_add(Weight::from_parts(74_519, 0).saturating_mul(s.into()))
			// Standard Error: 4
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(12_962_813, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 501
			.saturating_add(Weight::from_parts(63_715, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_228_951, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 1_346
			.saturating_add(Weight::from_parts(100_441, 0).saturating_mul(s.into()))
			// Standard Error: 8
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_602_978, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 744
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_899_178, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 710
			.saturating_add(Weight::from_parts(58_945, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_395_451, 0)
			.saturating_add(Weight::from_parts(0, 5659))
			// Standard Error: 686
			.saturating_add(Weight::from_parts(68_255, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
