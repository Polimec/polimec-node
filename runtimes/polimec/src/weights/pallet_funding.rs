...
impl<T: frame_system::Config> pallet_funding::WeightInfo for WeightInfo<T> {
	...
	fn bid(x: u32, y: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2866 + x * (192 ±0)`
		//  Estimated: `6208 + x * (2748 ±0)`
		// Minimum execution time: 274_581_000 picoseconds.
		Weight::from_parts(211_541_829, 0)
			.saturating_add(Weight::from_parts(0, 6208))
			// Standard Error: 261_236
			.saturating_add(Weight::from_parts(3_389_028, 0).saturating_mul(x.into()))
			// Standard Error: 163_796
			.saturating_add(Weight::from_parts(68_717_795, 0).saturating_mul(y.into()))
