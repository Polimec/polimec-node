...
use polimec_parachain_runtime::{
	...
	ParachainInfoConfig, PolkadotXcmConfig, SessionConfig, SessionKeys, SudoConfig, SystemConfig,
...
fn testnet_genesis(
	wasm_binary: &[u8], _stakers: Vec<(AccountId, Option<AccountId>, Balance)>, _inflation_config: InflationInfo,
	_max_candidate_stake: Balance, initial_authorities: Vec<(AccountId, AuthorityId)>,
