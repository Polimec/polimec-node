...
fn excel_bidders() -> Vec<BidParams<PolimecRuntime>> {
	vec![
		BidParams::from(ADAMS.into(), 700 * ASSET_UNIT),
		BidParams::from(POLK.into(), 4000 * ASSET_UNIT),
		BidParams::from(MARKUS.into(), 3000 * ASSET_UNIT),
		BidParams::from(ELLA.into(), 700 * ASSET_UNIT),
		BidParams::from(SKR.into(), 3400 * ASSET_UNIT),
		BidParams::from(ARTHUR.into(), 1000 * ASSET_UNIT),
		BidParams::from(MILA.into(), 8400 * ASSET_UNIT),
		BidParams::from(LINCOLN.into(), 800 * ASSET_UNIT),
		BidParams::from(MONROE.into(), 1300 * ASSET_UNIT),
		BidParams::from(ARBRESHA.into(), 5000 * ASSET_UNIT),
		BidParams::from(ELDIN.into(), 600 * ASSET_UNIT),
		BidParams::from(HARDING.into(), 800 * ASSET_UNIT),
		BidParams::from(SOFIA.into(), 3000 * ASSET_UNIT),
		BidParams::from(DOMINIK.into(), 8000 * ASSET_UNIT),
		BidParams::from(NOLAND.into(), 900 * ASSET_UNIT),
		BidParams::from(LINA.into(), 8400 * ASSET_UNIT),
		BidParams::from(LINA.into(), 1000 * ASSET_UNIT),
		BidParams::from(HANNAH.into(), 400 * ASSET_UNIT),
		BidParams::from(HOOVER.into(), 2000 * ASSET_UNIT),
		BidParams::from(GIGI.into(), 600 * ASSET_UNIT),
		BidParams::from(JEFFERSON.into(), 1000 * ASSET_UNIT),
		BidParams::from(JEFFERSON.into(), 2000 * ASSET_UNIT),
	]
}
